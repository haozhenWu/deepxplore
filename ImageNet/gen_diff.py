...
parser.add_argument('-occl_size', '--occlusion_size', help="occlusion size", default=(25, 25), type=tuple)
...
for i in xrange(args.seeds):
    ...
    if not label1 == label2 == label3:
        ...
        imsave('./generated_inputs/' + 'already_differ_' + 'index' + str(index[i]) + '_' + decode_label(pred1) + '_' + decode_label(
    ...
    for iters in xrange(args.grad_iterations):
        ...
        if not label1 == label2 == label3:
            ...
            # save the result to disk
            imsave('./generated_inputs/' + args.transformation + '_' + 'index' + str(index[i]) + '_' + decode_label(pred1) + '_' + decode_label(
